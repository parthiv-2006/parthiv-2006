...
[parthivpaul.me](https://www.parthivpaul.me)

---

Right now I'm building **[Glowi](https://github.com/parthiv-2006/Glowi)**, an AI skincare app for React Native. Photograph a concern and get a severity-scored breakdown with product recommendations, PubMed-cited nutrition advice, and live UV/AQI routine adjustments.  
...
**[Angler](https://github.com/parthiv-2006/Angler)** · [angler.software](https://angler.software) · $5,000 ItsTodayMedia Build Challenge  
AI creative-strategy engine for media buyers. Mines real competitor ads from Meta's Ad Library, extracts winning patterns with a vision-language model, and scores your own ad set for algorithmic redundancy against Meta's Andromeda system before generating new ad angles. Also ships as a public MCP server.  
`Next.js` `TypeScript` `Claude` `Supabase` `MCP`
...
**[Palate](https://github.com/parthiv-2006/palate)** · [palate-self.vercel.app](https://palate-self.vercel.app) · UoftHacks 2026  
